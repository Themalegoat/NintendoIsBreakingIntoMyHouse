...
Step two 2.
	...
	-Copy and paste both the title keys and prod keys (found in D:/SwitchShit/4. prod keys) into the key folder (photo 2)
...
Step seven 7.
	...
	-Once clicked navigate to the 3.Updates folder and select the singular file listed adn click done, the update should go through
